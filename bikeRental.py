...
class BikeRental:
    ...
    def rentBikeOnHourlyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged Rs.10 for each hour per bike.")
    ...
    def rentBikeOnDailyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged Rs.40 for each day per bike.")
            print("We hope that you enjoy our service.")
    ...
    def rentBikeOnWeeklyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged Rs.120 for each week per bike.")
            print("We hope that you enjoy our service.")
            self.stock -= n
    ...
    def returnBike(self, request):
        ...
        if rentalTime and rentalBasis and numOfBikes:
            ...
            # weekly bill calculation
                ...
                bill = round(rentalPeriod.days / 7) * 120 * numOfBikes
